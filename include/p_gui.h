...
extern void gui_fb_draw_rect(rect_st rect, uint8_t color, int mark_dirty);
...
extern void gui_fb_draw_image(rect_st rect, bitmap_st *bitmap);
extern void gui_fb_draw_pixelart(rect_st rect, bitmap_st *bitmap);
...
extern int gui_wm_is_valid_pattern(bitmap_st *b);
extern int gui_wm_is_valid_pixelart(bitmap_st *b);
extern int gui_wm_is_valid_image(bitmap_st *b);
extern int gui_wm_is_valid_wallpaper(bitmap_st *b);
